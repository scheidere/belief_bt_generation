...
class Robot:
    ...
    def __init__(self, config, bt, world, x, y, theta):
        # testing different actions in a row
        # self.tick = 0
    ...
    def do_iteration(self):
        ...
        # # testing different actions, comment out here if not needed
        # if self.tick == 0:
...
class Controller:
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            # robot action is a true/false whether that action succeeded
            # active_actions is the list of active actions
            print("Active ids: ", self.robot.bt.active_ids)
            print("active actions: ", active_actions)
            num_iterations += 1
