...
class World():
    ...
    #    for obj in objects:
    #        if robot_pos[0] > obj_x and robot_pos[0] < obj_h
    #            return 
    ...
    def world_plot(self, iteration):
        ...
        if self.h_state == None:
            ...
            fig.canvas.draw()
            #plt.pause(0.1)
        plt.savefig("/home/prg/old_sim/src/belief_bt_generation/infant_simulator/src/infant_simulator/images/test_" + str(self.image_counter) + ".png")  # , bbox='tight')  # , bbox_extra_artists=[legend])
        #plt.savefig("/home/ahelmi/test_inf_sim/src/belief_bt_generation/infant_simulator/src/infant_simulator/images/test_" + str(iteration) + ".png")  # , bbox='tight')  # , bbox_extra_artists=[legend])
