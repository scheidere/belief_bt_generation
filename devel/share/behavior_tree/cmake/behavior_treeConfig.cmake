...
if("TRUE" STREQUAL "TRUE")
  set(behavior_tree_SOURCE_PREFIX /home/ahelmi/infant_sim_testing/src/behavior_tree)
  set(behavior_tree_DEVEL_PREFIX /home/ahelmi/infant_sim_testing/devel)
  ...
  set(behavior_tree_INSTALL_PREFIX /home/ahelmi/infant_sim_testing/install)
...
if(NOT "/home/ahelmi/infant_sim_testing/src/behavior_tree/include " STREQUAL " ")
  set(behavior_tree_INCLUDE_DIRS "")
  set(_include_dirs "/home/ahelmi/infant_sim_testing/src/behavior_tree/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'behavior_tree' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ahelmi/infant_sim_testing/src/behavior_tree/${idir}'.  ${_report}")
    endif()
    _list_append_unique(behavior_tree_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "behavior_tree")
...
set(behavior_tree_EXPORTED_TARGETS "")
...
set(depends "roscpp;rospy;std_msgs;behavior_tree_msgs")
foreach(depend ${depends})
  ...
  list(APPEND behavior_tree_EXPORTED_TARGETS ${${behavior_tree_dep}_EXPORTED_TARGETS})
endforeach()
